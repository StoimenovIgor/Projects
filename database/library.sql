...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2022 at 10:36 PM
...
(13, 'Igor', 'Dzmabazov', 'Igor Džambazov is a Macedonian actor, showman, TV presenter, comedian, singer, songwriter, and prosaist. He was born on July 15, 1963 in Skopje to composer Aleksandar Džambazov and actress Anče Džambazova. His grandfather was the renowned Macedonian actor Petre Prličko.', 0);
...
(14, 1, 29, 'Very good book.', '2022-12-02 21:16:46');
...
(28, 'Igor', 'Stoimenov', 'Admin123', 'example@example.com', '$2y$10$N/gynzSMWIlX9Cf6ouBmQ.P1EoeZMG5Mh.LvsnBFSbPFJAVnylWiG', 2),
(29, 'Igor', 'Stoimenov', 'Student', 'student@student.com', '$2y$10$G9VORgsNEpGv676FfJamy.deTycdx96ITrh3zXIptDSrXZoVfHIVG', 1);
