...
if (empty($_POST['review'])) {
    ...
    $_SESSION['val'] = ['review' > 255, 'text' => 'Review field must be maximum 255 characters.'];
    redirect(route('book', $_GET['id']));
} else {
    input_data($_POST['review']);
}

$sql = "INSERT INTO book_reviews (id, book_id, user_id, review, created_at, is_approved) VALUES (:book_id, :user_id, :review)";
